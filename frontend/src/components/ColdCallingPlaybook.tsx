    ...
    <div className="bg-white/90 backdrop-blur-md border border-slate-200 rounded-2xl p-6 shadow-xl space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 pb-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-xs bg-slate-100 hover:bg-slate-200 text-slate-700 px-3 py-1.5 rounded-lg border border-slate-200 transition-colors self-start sm:self-auto"
        >
          {copied ? (
            <>
      ...
      <div className="space-y-3 font-sans text-xs">
        ...
        <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-1">
          ...
          <p className="text-slate-700">
            <strong className="text-slate-900">You:</strong> &quot;We help local businesses in Gandhinagar get an affordable, clean website set up in 48 hours to get direct customer orders without hefty platform commissions. Would it be okay if I sent a 1-minute WhatsApp preview demo of what your website could look like?&quot;
          </p>
        </div>
      </div>
